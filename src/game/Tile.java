...
public class Tile {
    ...
    /**
     * True if the coins on this Tile have been picked up
     */
    ...
    private boolean isEnemyPresent;  // Add this field to track enemies
    ...
    public void setEnemyPresent(boolean isEnemyPresent) {
